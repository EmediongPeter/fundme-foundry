...
deploy-sepolia:
	forge script script/DeployFundme.s.sol:DeployFundMeScript --rpc-url $(SEPOLIA_RPC_URL) --private-key $(METAMASK_PRIVATE_KEY) --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY)
